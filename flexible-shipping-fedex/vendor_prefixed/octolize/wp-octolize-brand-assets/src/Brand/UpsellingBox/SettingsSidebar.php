 ...
 */
class SettingsSidebar implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
    ...
    public function __construct($action, \FedExVendor\WPDesk\ShowDecision\ShouldShowStrategy $should_show_strategy, $title, array $features, $url, $label, $min_width = 1000, $position_right = 20, $align_top_to_element = '#mainform h2:first', $additional_content = '')
    {
        $this->action = $action;
