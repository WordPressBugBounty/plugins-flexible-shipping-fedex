...
final class ConsentSettings
{
    ...
    {
        return [self::TITLE => __('Do you consent to sending data to the chat?', 'flexible-shipping-fedex'), self::MESSAGE => __('To start the chat, we need to send your inputs and technical data to the chat service. Read more in our Privacy Policy.', 'flexible-shipping-fedex'), self::ACCEPT => __('Accept', 'flexible-shipping-fedex'), self::DECLINE => __('Decline', 'flexible-shipping-fedex'), self::PRIVACY_POLICY_URL => 'https://octolize.com/terms-of-service/privacy-policy/', self::PRIVACY_LINK_LABEL => __('Privacy Policy', 'flexible-shipping-fedex'), self::SUPPORT_URL => 'https://octolize.com/support/', self::SUPPORT_TEXT => __('If you don’t want to give consent, you can contact our support using this form:', 'flexible-shipping-fedex'), self::SUPPORT_LINK_LABEL => __('Support form', 'flexible-shipping-fedex')];
    }
}
