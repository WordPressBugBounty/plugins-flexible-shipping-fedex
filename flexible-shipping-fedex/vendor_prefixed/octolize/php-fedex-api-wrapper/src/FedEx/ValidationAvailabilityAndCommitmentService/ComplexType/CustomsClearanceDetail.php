 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ClearanceBrokerageType|string $ClearanceBrokerage
 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\InternationalDocumentContentType|string $DocumentContent
 * @property Money $CustomsValue
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightOnValueType|string $FreightOnValue
 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RegulatoryControlType|string[] $RegulatoryControls
...
class CustomsClearanceDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ClearanceBrokerageType|string $clearanceBrokerage
     * @return $this
     */
     ...
     * Set DocumentContent
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\InternationalDocumentContentType|string $documentContent
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightOnValueType|string $freightOnValue
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RegulatoryControlType[]|string[] $regulatoryControls
     * @return $this
     */
