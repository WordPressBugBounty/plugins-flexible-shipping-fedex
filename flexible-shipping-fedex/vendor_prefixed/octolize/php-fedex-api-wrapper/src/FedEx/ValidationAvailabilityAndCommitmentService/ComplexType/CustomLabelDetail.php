 ...
 *
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\CustomLabelCoordinateUnits|string $CoordinateUnits
...
class CustomLabelDetail extends AbstractComplexType
{
     ...
     * Set CoordinateUnits
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\CustomLabelCoordinateUnits|string $coordinateUnits
     * @return $this
     */
