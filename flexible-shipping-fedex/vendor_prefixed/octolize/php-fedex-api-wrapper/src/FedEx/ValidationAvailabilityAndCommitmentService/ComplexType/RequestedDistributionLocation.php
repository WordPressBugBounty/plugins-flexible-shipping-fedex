 ...
 *
 * @property string $Id
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FedExDistributionLocationType|string $Type
...
class RequestedDistributionLocation extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FedExDistributionLocationType|string $type
     * @return $this
     */
