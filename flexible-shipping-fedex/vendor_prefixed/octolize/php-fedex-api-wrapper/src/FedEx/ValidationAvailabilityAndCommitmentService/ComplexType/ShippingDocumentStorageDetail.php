 ...
 *
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentStorageDetailType|string $Type
 * @property string $FilePath
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentNamingType|string $FileNaming
...
class ShippingDocumentStorageDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentStorageDetailType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentNamingType|string $fileNaming
     * @return $this
     */
