 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RotationType|string $Rotation
 */
class CustomLabelTextBoxEntry extends AbstractComplexType
{
     ...
     * Set Rotation
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RotationType|string $rotation
     * @return $this
     */
