 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\HazardousCommodityQuantityType|string $QuantityType
 */
class HazardousCommodityQuantityDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\HazardousCommodityQuantityType|string $quantityType
     * @return $this
     */
