 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PhysicalFormType|string $PhysicalForm
...
class RadionuclideDetail extends AbstractComplexType
{
     ...
     * Set PhysicalForm
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PhysicalFormType|string $physicalForm
     * @return $this
     */
