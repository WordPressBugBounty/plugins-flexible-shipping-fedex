 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\DistributionClearanceType|string $ClearanceType
...
class ShipmentInternationalDistributionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\DistributionClearanceType|string $clearanceType
     * @return $this
     */
