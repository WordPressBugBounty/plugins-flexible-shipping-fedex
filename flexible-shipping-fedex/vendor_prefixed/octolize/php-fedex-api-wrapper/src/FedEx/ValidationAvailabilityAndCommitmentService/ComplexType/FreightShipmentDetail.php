 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightShipmentRoleType|string $Role
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightCollectTermsType|string $CollectTermsType
...
class FreightShipmentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightShipmentRoleType|string $role
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightCollectTermsType|string $collectTermsType
     * @return $this
     */
