 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\DocTabZoneJustificationType|string $Justification
 */
class DocTabZoneSpecification extends AbstractComplexType
{
     ...
     * Set Justification
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\DocTabZoneJustificationType|string $justification
     * @return $this
     */
