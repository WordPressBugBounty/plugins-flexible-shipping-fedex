 ...
 *
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PendingShipmentType|string $Type
...
class PendingShipmentDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PendingShipmentType|string $type
     * @return $this
     */
