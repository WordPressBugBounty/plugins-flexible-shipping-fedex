 ...
 *
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\NotificationType|string $NotificationType
...
class NotificationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\NotificationType|string $notificationType
     * @return $this
     */
