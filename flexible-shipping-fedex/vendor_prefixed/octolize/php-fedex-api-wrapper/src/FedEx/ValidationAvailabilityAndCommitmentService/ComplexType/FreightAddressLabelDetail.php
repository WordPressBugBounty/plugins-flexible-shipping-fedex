 ...
 * @property int $Copies
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PageQuadrantType|string $StartingPosition
...
class FreightAddressLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PageQuadrantType|string $startingPosition
     * @return $this
     */
