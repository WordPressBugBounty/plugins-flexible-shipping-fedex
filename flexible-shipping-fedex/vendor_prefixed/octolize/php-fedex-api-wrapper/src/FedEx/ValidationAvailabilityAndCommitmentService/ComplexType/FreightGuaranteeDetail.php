 ...
 *
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightGuaranteeType|string $Type
...
class FreightGuaranteeDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightGuaranteeType|string $type
     * @return $this
     */
