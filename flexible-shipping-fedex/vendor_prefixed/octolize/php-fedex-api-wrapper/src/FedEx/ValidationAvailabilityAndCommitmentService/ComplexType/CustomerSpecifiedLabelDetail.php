 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RelativeVerticalPositionType|string $CustomContentPosition
 * @property CustomLabelDetail $CustomContent
 * @property ConfigurableLabelReferenceEntry[] $ConfigurableReferenceEntries
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\LabelMaskableDataType|string[] $MaskedData
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\SecondaryBarcodeType|string $SecondaryBarcode
...
class CustomerSpecifiedLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\RelativeVerticalPositionType|string $customContentPosition
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\LabelMaskableDataType[]|string[] $maskedData
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\SecondaryBarcodeType|string $secondaryBarcode
     * @return $this
     */
