 ...
 *
 * @property string $Id
 * @property \FedEx\ShipService\SimpleType\EPaymentProcessorType|string $EPaymentProcessor
 * @property \FedEx\ShipService\SimpleType\EPaymentModeType|string $EPaymentMode
 * @property string $MaskedCreditCard
 * @property \FedEx\ShipService\SimpleType\CreditCardType|string $CreditCardType
...
class EPaymentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ShipService\SimpleType\EPaymentProcessorType|string $ePaymentProcessor
     * @return $this
     */
     ...
     * Set EPaymentMode
     *
     * @param \FedEx\ShipService\SimpleType\EPaymentModeType|string $ePaymentMode
     * @return $this
     */
     ...
     * Set CreditCardType
     *
     * @param \FedEx\ShipService\SimpleType\CreditCardType|string $creditCardType
     * @return $this
     */
