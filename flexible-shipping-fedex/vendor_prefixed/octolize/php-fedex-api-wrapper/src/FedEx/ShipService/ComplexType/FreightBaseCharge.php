 ...
 * @property \FedEx\ShipService\SimpleType\FreightClassType|string $RatedAsClass
 * @property string $NmfcCode
 * @property string $Description
 * @property Weight $Weight
 * @property Money $ChargeRate
 * @property \FedEx\ShipService\SimpleType\FreightChargeBasisType|string $ChargeBasis
