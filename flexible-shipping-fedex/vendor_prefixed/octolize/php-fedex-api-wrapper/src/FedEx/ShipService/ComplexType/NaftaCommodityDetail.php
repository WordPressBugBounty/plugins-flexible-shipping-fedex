 ...
 *
 * @property \FedEx\ShipService\SimpleType\NaftaPreferenceCriterionCode|string $PreferenceCriterion
 * @property \FedEx\ShipService\SimpleType\NaftaProducerDeterminationCode|string $ProducerDetermination
 * @property string $ProducerId
 * @property \FedEx\ShipService\SimpleType\NaftaNetCostMethodCode|string $NetCostMethod
