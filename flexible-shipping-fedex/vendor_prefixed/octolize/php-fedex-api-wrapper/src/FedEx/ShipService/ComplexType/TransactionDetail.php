...
class TransactionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\ShipService\SimpleType\TransactionSourceFormat|string $sourceFormat
     * @return $this
     */
     ...
     *
     * @param \FedEx\ShipService\SimpleType\WebServiceEnvironment|string $environment
     * @return $this
     */
