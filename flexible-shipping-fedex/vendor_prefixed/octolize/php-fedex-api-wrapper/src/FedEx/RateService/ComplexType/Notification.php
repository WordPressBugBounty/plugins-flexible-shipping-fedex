 ...
 *
 * @property \FedEx\RateService\SimpleType\NotificationSeverityType|string $Severity
...
class Notification extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\RateService\SimpleType\NotificationSeverityType|string $severity
     * @return $this
     */
