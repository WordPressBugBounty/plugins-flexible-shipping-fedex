 ...
 *
 * @property \FedEx\RateService\SimpleType\InternationalControlledExportType|string $Type
...
class InternationalControlledExportDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\RateService\SimpleType\InternationalControlledExportType|string $type
     * @return $this
     */
