 ...
 *
 * @property \FedEx\RateService\SimpleType\ShippingDocumentDispositionType|string $DispositionType
 * @property \FedEx\RateService\SimpleType\ShippingDocumentGroupingType|string $Grouping
