 ...
 *
 * @property \FedEx\InFlightShipmentService\SimpleType\ShippingDocumentDispositionType|string $DispositionType
 * @property \FedEx\InFlightShipmentService\SimpleType\ShippingDocumentGroupingType|string $Grouping
...
class ShippingDocumentDispositionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\InFlightShipmentService\SimpleType\ShippingDocumentDispositionType|string $dispositionType
     * @return $this
     */
     ...
     *
     * @param \FedEx\InFlightShipmentService\SimpleType\ShippingDocumentGroupingType|string $grouping
     * @return $this
     */
