 ...
 *
 * @property \FedEx\InFlightShipmentService\SimpleType\NotificationSeverityType|string $Severity
...
class Notification extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\InFlightShipmentService\SimpleType\NotificationSeverityType|string $severity
     * @return $this
     */
