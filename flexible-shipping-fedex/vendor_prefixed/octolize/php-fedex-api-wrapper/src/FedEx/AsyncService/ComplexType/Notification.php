 ...
 *
 * @property \FedEx\AsyncService\SimpleType\NotificationSeverityType|string $Severity
...
class Notification extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\AsyncService\SimpleType\NotificationSeverityType|string $severity
     * @return $this
     */
