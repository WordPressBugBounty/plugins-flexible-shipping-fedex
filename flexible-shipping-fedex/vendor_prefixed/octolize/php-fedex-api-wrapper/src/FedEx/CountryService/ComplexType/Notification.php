 ...
 *
 * @property \FedEx\CountryService\SimpleType\NotificationSeverityType|string $Severity
...
class Notification extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\CountryService\SimpleType\NotificationSeverityType|string $severity
     * @return $this
     */
