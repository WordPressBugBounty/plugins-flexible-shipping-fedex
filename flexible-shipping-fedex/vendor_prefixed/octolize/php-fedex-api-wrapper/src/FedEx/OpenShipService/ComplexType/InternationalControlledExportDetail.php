 ...
 *
 * @property \FedEx\OpenShipService\SimpleType\InternationalControlledExportType|string $Type
...
class InternationalControlledExportDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\OpenShipService\SimpleType\InternationalControlledExportType|string $type
     * @return $this
     */
