 ...
 * @property \FedEx\OpenShipService\SimpleType\RateElementBasisType|string $RateElementBasis
...
class VariableHandlingChargeDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\RateElementBasisType|string $rateElementBasis
     * @return $this
     */
