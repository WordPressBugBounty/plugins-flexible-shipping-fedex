 ...
 *
 * @property \FedEx\OpenShipService\SimpleType\CustomLabelCoordinateUnits|string $CoordinateUnits
...
class CustomLabelDetail extends AbstractComplexType
{
     ...
     * Set CoordinateUnits
     *
     * @param \FedEx\OpenShipService\SimpleType\CustomLabelCoordinateUnits|string $coordinateUnits
     * @return $this
     */
