 ...
 * @property \FedEx\OpenShipService\SimpleType\DayOfWeekType|string $DeliveryDay
 * @property string $PublishedDeliveryTime
 * @property string $CommitDate
 * @property \FedEx\OpenShipService\SimpleType\DayOfWeekType|string $CommitDay
 * @property \FedEx\OpenShipService\SimpleType\TransitTimeType|string $TransitTime
 * @property \FedEx\OpenShipService\SimpleType\TransitTimeType|string $MaximumTransitTime
 * @property \FedEx\OpenShipService\SimpleType\TransitTimeType|string $CustomTransitTime
 * @property boolean $IneligibleForMoneyBackGuarantee
 * @property \FedEx\OpenShipService\SimpleType\GroundDeliveryEligibilityType|string[] $DeliveryEligibilities
...
class ShipmentOperationalDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\DayOfWeekType|string $deliveryDay
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\DayOfWeekType|string $commitDay
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\TransitTimeType|string $transitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\TransitTimeType|string $maximumTransitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\TransitTimeType|string $customTransitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\GroundDeliveryEligibilityType[]|string[] $deliveryEligibilities
     * @return $this
     */
