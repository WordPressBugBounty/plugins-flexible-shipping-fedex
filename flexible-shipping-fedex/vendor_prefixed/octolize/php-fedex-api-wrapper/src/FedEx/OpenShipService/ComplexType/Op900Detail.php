 ...
 * @property \FedEx\OpenShipService\SimpleType\CustomerReferenceType|string $Reference
...
class Op900Detail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\CustomerReferenceType|string $reference
     * @return $this
     */
