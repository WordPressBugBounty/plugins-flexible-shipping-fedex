 ...
 *
 * @property \FedEx\OpenShipService\SimpleType\ShipmentNotificationAggregationType|string $AggregationType
...
class ShipmentEventNotificationDetail extends AbstractComplexType
{
     ...
     * Set AggregationType
     *
     * @param \FedEx\OpenShipService\SimpleType\ShipmentNotificationAggregationType|string $aggregationType
     * @return $this
     */
