 ...
 * @property \FedEx\OpenShipService\SimpleType\HazardousCommodityRegulationType|string $Regulation
 * @property \FedEx\OpenShipService\SimpleType\DangerousGoodsAccessibilityType|string $Accessibility
 * @property boolean $CargoAircraftOnly
 * @property \FedEx\OpenShipService\SimpleType\HazardousCommodityOptionType|string[] $Options
 * @property \FedEx\OpenShipService\SimpleType\DangerousGoodsPackingOptionType|string $PackingOption
...
class DangerousGoodsDetail extends AbstractComplexType
{
     ...
     * Set Regulation
     *
     * @param \FedEx\OpenShipService\SimpleType\HazardousCommodityRegulationType|string $regulation
     * @return $this
     */
     ...
     * Set Accessibility
     *
     * @param \FedEx\OpenShipService\SimpleType\DangerousGoodsAccessibilityType|string $accessibility
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\HazardousCommodityOptionType[]|string[] $options
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\DangerousGoodsPackingOptionType|string $packingOption
     * @return $this
     */
