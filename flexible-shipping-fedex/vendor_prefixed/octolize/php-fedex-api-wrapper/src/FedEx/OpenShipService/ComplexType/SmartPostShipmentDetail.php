 ...
 * @property \FedEx\OpenShipService\SimpleType\SmartPostIndiciaType|string $Indicia
 * @property \FedEx\OpenShipService\SimpleType\SmartPostAncillaryEndorsementType|string $AncillaryEndorsement
...
class SmartPostShipmentDetail extends AbstractComplexType
{
     ...
     * Set Indicia
     *
     * @param \FedEx\OpenShipService\SimpleType\SmartPostIndiciaType|string $indicia
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\SmartPostAncillaryEndorsementType|string $ancillaryEndorsement
     * @return $this
     */
