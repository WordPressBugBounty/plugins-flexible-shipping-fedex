 ...
 *
 * @property \FedEx\OpenShipService\SimpleType\TrackingIdType|string $TrackingIdType
...
class TrackingId extends AbstractComplexType
{
     ...
     * Set TrackingIdType
     *
     * @param \FedEx\OpenShipService\SimpleType\TrackingIdType|string $trackingIdType
     * @return $this
     */
