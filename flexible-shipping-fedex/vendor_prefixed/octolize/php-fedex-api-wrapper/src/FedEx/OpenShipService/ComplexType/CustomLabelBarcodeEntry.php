 ...
 * @property \FedEx\OpenShipService\SimpleType\BarcodeSymbologyType|string $BarcodeSymbology
 */
class CustomLabelBarcodeEntry extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\BarcodeSymbologyType|string $barcodeSymbology
     * @return $this
     */
