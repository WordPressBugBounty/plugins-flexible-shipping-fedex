 ...
 *
 * @property \FedEx\OpenShipService\SimpleType\CustomDeliveryWindowType|string $Type
...
class CustomDeliveryWindowDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\CustomDeliveryWindowType|string $type
     * @return $this
     */
