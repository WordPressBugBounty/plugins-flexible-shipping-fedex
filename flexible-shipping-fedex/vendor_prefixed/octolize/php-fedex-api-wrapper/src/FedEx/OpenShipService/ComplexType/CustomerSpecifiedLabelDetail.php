 ...
 * @property \FedEx\OpenShipService\SimpleType\LabelMaskableDataType|string[] $MaskedData
 * @property \FedEx\OpenShipService\SimpleType\SecondaryBarcodeType|string $SecondaryBarcode
...
class CustomerSpecifiedLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\LabelMaskableDataType[]|string[] $maskedData
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\SecondaryBarcodeType|string $secondaryBarcode
     * @return $this
     */
