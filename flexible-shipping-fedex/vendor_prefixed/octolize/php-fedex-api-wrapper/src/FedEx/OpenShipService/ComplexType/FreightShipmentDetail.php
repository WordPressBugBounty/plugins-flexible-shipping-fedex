 ...
 * @property \FedEx\OpenShipService\SimpleType\FreightShipmentRoleType|string $Role
 * @property \FedEx\OpenShipService\SimpleType\FreightCollectTermsType|string $CollectTermsType
...
class FreightShipmentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\FreightShipmentRoleType|string $role
     * @return $this
     */
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\FreightCollectTermsType|string $collectTermsType
     * @return $this
     */
