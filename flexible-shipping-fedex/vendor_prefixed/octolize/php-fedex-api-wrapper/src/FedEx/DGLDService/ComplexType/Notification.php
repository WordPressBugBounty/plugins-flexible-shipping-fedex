...
namespace FedExVendor\FedEx\DGLDService\ComplexType;
 ...
 *
 * @property \FedEx\DGLDService\SimpleType\NotificationSeverityType|string $Severity
...
class Notification extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\DGLDService\SimpleType\NotificationSeverityType|string $severity
     * @return $this
     */
