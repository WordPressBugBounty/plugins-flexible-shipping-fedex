 ...
 * @property \FedEx\UploadDocumentService\SimpleType\CustomerReferenceType|string $Reference
...
class Op900Detail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CustomerReferenceType|string $reference
     * @return $this
     */
