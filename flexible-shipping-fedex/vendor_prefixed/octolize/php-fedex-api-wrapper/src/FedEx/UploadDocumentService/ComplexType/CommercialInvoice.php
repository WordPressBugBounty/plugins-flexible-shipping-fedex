 ...
 * @property \FedEx\UploadDocumentService\SimpleType\TaxesOrMiscellaneousChargeType|string $TaxesOrMiscellaneousChargeType
 ...
 * @property \FedEx\UploadDocumentService\SimpleType\PurposeOfShipmentType|string $Purpose
...
class CommercialInvoice extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\TaxesOrMiscellaneousChargeType|string $taxesOrMiscellaneousChargeType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\PurposeOfShipmentType|string $purpose
     * @return $this
     */
