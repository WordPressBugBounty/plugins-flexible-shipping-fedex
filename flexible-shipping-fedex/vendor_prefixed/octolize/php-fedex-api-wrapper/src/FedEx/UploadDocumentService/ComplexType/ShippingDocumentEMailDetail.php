 ...
 * @property \FedEx\UploadDocumentService\SimpleType\ShippingDocumentEMailGroupingType|string $Grouping
...
class ShippingDocumentEMailDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ShippingDocumentEMailGroupingType|string $grouping
     * @return $this
     */
