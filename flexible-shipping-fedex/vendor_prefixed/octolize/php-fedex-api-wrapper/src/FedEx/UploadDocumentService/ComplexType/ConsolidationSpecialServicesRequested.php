 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\ConsolidationSpecialServiceType|string[] $SpecialServiceTypes
...
class ConsolidationSpecialServicesRequested extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ConsolidationSpecialServiceType[]|string[] $specialServiceTypes
     * @return $this
     */
