 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\DestinationControlStatementType|string[] $StatementTypes
...
class DestinationControlDetail extends AbstractComplexType
{
     ...
     * Set StatementTypes
     *
     * @param \FedEx\UploadDocumentService\SimpleType\DestinationControlStatementType[]|string[] $statementTypes
     * @return $this
     */
