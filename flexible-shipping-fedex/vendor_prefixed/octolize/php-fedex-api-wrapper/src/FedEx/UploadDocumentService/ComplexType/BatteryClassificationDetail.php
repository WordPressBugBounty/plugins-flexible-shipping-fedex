 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\BatteryMaterialType|string $Material
 * @property \FedEx\UploadDocumentService\SimpleType\BatteryPackingType|string $Packing
 * @property \FedEx\UploadDocumentService\SimpleType\BatteryRegulatorySubType|string $RegulatorySubType
 */
class BatteryClassificationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\BatteryMaterialType|string $material
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\BatteryPackingType|string $packing
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\BatteryRegulatorySubType|string $regulatorySubType
     * @return $this
     */
