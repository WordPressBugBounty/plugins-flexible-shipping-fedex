 ...
 * @property \FedEx\UploadDocumentService\SimpleType\CommodityPurposeType|string $Purpose
...
class Commodity extends AbstractComplexType
{
     ...
     * Set Purpose
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CommodityPurposeType|string $purpose
     * @return $this
     */
