 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\B13AFilingOptionType|string $B13AFilingOption
...
class ExportDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\B13AFilingOptionType|string $b13AFilingOption
     * @return $this
     */
