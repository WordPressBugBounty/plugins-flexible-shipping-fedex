 ...
 * @property \FedEx\UploadDocumentService\SimpleType\PhysicalFormType|string $PhysicalForm
...
class RadionuclideDetail extends AbstractComplexType
{
     ...
     * Set PhysicalForm
     *
     * @param \FedEx\UploadDocumentService\SimpleType\PhysicalFormType|string $physicalForm
     * @return $this
     */
