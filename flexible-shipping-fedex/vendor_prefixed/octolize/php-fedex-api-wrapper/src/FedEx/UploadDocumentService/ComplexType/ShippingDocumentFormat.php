 ...
 * @property \FedEx\UploadDocumentService\SimpleType\ShippingDocumentStockType|string $StockType
...
class ShippingDocumentFormat extends AbstractComplexType
{
     ...
     * Set StockType
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ShippingDocumentStockType|string $stockType
     * @return $this
     */
