 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\RecommendedDocumentType|string[] $Types
 */
class RecommendedDocumentSpecification extends AbstractComplexType
{
     ...
     * Set Types
     *
     * @param \FedEx\UploadDocumentService\SimpleType\RecommendedDocumentType[]|string[] $types
     * @return $this
     */
