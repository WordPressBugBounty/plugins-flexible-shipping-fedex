 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\EtdConfirmationType|string $Confirmation
 * @property \FedEx\UploadDocumentService\SimpleType\EtdAttributeType|string[] $Attributes
 * @property \FedEx\UploadDocumentService\SimpleType\RequestedShippingDocumentType|string[] $RequestedDocumentCopies
...
class EtdDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\EtdConfirmationType|string $confirmation
     * @return $this
     */
     ...
     * Set Attributes
     *
     * @param \FedEx\UploadDocumentService\SimpleType\EtdAttributeType[]|string[] $attributes
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\RequestedShippingDocumentType[]|string[] $requestedDocumentCopies
     * @return $this
     */
