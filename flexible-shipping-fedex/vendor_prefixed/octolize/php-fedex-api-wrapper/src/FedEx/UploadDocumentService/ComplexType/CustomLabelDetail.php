 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\CustomLabelCoordinateUnits|string $CoordinateUnits
...
class CustomLabelDetail extends AbstractComplexType
{
     ...
     * Set CoordinateUnits
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CustomLabelCoordinateUnits|string $coordinateUnits
     * @return $this
     */
