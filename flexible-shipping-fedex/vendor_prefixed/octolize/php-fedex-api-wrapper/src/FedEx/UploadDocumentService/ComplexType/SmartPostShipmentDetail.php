 ...
 * @property \FedEx\UploadDocumentService\SimpleType\SmartPostIndiciaType|string $Indicia
 * @property \FedEx\UploadDocumentService\SimpleType\SmartPostAncillaryEndorsementType|string $AncillaryEndorsement
 * @property \FedEx\UploadDocumentService\SimpleType\SmartPostShipmentSpecialServiceType|string[] $SpecialServices
...
class SmartPostShipmentDetail extends AbstractComplexType
{
     ...
     * Set Indicia
     *
     * @param \FedEx\UploadDocumentService\SimpleType\SmartPostIndiciaType|string $indicia
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\SmartPostAncillaryEndorsementType|string $ancillaryEndorsement
     * @return $this
     */
     ...
     * Set SpecialServices
     *
     * @param \FedEx\UploadDocumentService\SimpleType\SmartPostShipmentSpecialServiceType[]|string[] $specialServices
     * @return $this
     */
