 ...
 * @property \FedEx\UploadDocumentService\SimpleType\ClearanceBrokerageType|string $ClearanceBrokerage
 ...
 * @property \FedEx\UploadDocumentService\SimpleType\InternationalDocumentContentType|string $DocumentContent
 * @property Money $CustomsValue
 * @property \FedEx\UploadDocumentService\SimpleType\FreightOnValueType|string $FreightOnValue
 ...
 * @property \FedEx\UploadDocumentService\SimpleType\RegulatoryControlType|string[] $RegulatoryControls
...
class CustomsClearanceDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ClearanceBrokerageType|string $clearanceBrokerage
     * @return $this
     */
     ...
     * Set DocumentContent
     *
     * @param \FedEx\UploadDocumentService\SimpleType\InternationalDocumentContentType|string $documentContent
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightOnValueType|string $freightOnValue
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\RegulatoryControlType[]|string[] $regulatoryControls
     * @return $this
     */
