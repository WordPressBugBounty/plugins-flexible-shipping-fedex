 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\PendingShipmentType|string $Type
...
class PendingShipmentDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentService\SimpleType\PendingShipmentType|string $type
     * @return $this
     */
