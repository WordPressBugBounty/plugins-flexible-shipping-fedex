 ...
 * @property \FedEx\UploadDocumentService\SimpleType\FreightClassType|string $RatedAsClass
 * @property string $NmfcCode
 * @property string $Description
 * @property Weight $Weight
 * @property Money $ChargeRate
 * @property \FedEx\UploadDocumentService\SimpleType\FreightChargeBasisType|string $ChargeBasis
...
class FreightBaseCharge extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightClassType|string $ratedAsClass
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightChargeBasisType|string $chargeBasis
     * @return $this
     */
