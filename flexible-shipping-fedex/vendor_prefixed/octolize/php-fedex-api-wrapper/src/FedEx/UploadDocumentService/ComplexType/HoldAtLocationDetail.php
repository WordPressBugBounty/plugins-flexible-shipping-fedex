 ...
 * @property \FedEx\UploadDocumentService\SimpleType\FedExLocationType|string $LocationType
...
class HoldAtLocationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FedExLocationType|string $locationType
     * @return $this
     */
