 ...
 * @property \FedEx\UploadDocumentService\SimpleType\HazardousCommodityQuantityType|string $QuantityType
 */
class HazardousCommodityQuantityDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\HazardousCommodityQuantityType|string $quantityType
     * @return $this
     */
