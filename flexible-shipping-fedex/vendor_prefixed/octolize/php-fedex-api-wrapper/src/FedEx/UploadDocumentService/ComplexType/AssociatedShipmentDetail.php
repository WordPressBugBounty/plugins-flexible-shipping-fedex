 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\AssociatedShipmentType|string $Type
...
class AssociatedShipmentDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentService\SimpleType\AssociatedShipmentType|string $type
     * @return $this
     */
