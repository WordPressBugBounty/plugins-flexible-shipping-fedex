 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\EMailNotificationRecipientType|string $RecipientType
...
class ShippingDocumentEMailRecipient extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\EMailNotificationRecipientType|string $recipientType
     * @return $this
     */
