 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\InternationalControlledExportType|string $Type
...
class InternationalControlledExportDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentService\SimpleType\InternationalControlledExportType|string $type
     * @return $this
     */
