 ...
 * @property \FedEx\UploadDocumentService\SimpleType\HazardousCommodityRegulationType|string $Regulation
 * @property \FedEx\UploadDocumentService\SimpleType\DangerousGoodsAccessibilityType|string $Accessibility
 * @property boolean $CargoAircraftOnly
 * @property \FedEx\UploadDocumentService\SimpleType\DangerousGoodsDescriptorType|string[] $DangerousGoodsDescriptors
 * @property \FedEx\UploadDocumentService\SimpleType\HazardousCommodityOptionType|string[] $Options
 * @property \FedEx\UploadDocumentService\SimpleType\DangerousGoodsPackingOptionType|string $PackingOption
...
class DangerousGoodsDetail extends AbstractComplexType
{
     ...
     * Set Regulation
     *
     * @param \FedEx\UploadDocumentService\SimpleType\HazardousCommodityRegulationType|string $regulation
     * @return $this
     */
     ...
     * Set Accessibility
     *
     * @param \FedEx\UploadDocumentService\SimpleType\DangerousGoodsAccessibilityType|string $accessibility
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\DangerousGoodsDescriptorType[]|string[] $dangerousGoodsDescriptors
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\HazardousCommodityOptionType[]|string[] $options
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\DangerousGoodsPackingOptionType|string $packingOption
     * @return $this
     */
