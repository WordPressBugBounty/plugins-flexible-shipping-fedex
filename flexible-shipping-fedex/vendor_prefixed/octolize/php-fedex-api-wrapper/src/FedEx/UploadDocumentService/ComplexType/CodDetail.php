 ...
 * @property \FedEx\UploadDocumentService\SimpleType\CodCollectionType|string $CollectionType
...
class CodDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CodCollectionType|string $collectionType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CodReturnReferenceIndicatorType|string $referenceIndicator
     * @return $this
     */
