 ...
 * @property \FedEx\UploadDocumentService\SimpleType\BarcodeSymbologyType|string $BarcodeSymbology
 */
class CustomLabelBarcodeEntry extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\BarcodeSymbologyType|string $barcodeSymbology
     * @return $this
     */
