 ...
 * @property \FedEx\UploadDocumentService\SimpleType\FreightShipmentRoleType|string $Role
 * @property \FedEx\UploadDocumentService\SimpleType\FreightCollectTermsType|string $CollectTermsType
...
class FreightShipmentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightShipmentRoleType|string $role
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightCollectTermsType|string $collectTermsType
     * @return $this
     */
