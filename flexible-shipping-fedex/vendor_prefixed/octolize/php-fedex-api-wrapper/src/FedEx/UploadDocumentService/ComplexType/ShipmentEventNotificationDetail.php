 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\ShipmentNotificationAggregationType|string $AggregationType
...
class ShipmentEventNotificationDetail extends AbstractComplexType
{
     ...
     * Set AggregationType
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ShipmentNotificationAggregationType|string $aggregationType
     * @return $this
     */
