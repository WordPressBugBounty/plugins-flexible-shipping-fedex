 ...
 * @property \FedEx\UploadDocumentService\SimpleType\RelativeVerticalPositionType|string $CustomContentPosition
 * @property CustomLabelDetail $CustomContent
 * @property ConfigurableLabelReferenceEntry[] $ConfigurableReferenceEntries
 * @property \FedEx\UploadDocumentService\SimpleType\LabelMaskableDataType|string[] $MaskedData
 * @property \FedEx\UploadDocumentService\SimpleType\SecondaryBarcodeType|string $SecondaryBarcode
...
class CustomerSpecifiedLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\RelativeVerticalPositionType|string $customContentPosition
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\LabelMaskableDataType[]|string[] $maskedData
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\SecondaryBarcodeType|string $secondaryBarcode
     * @return $this
     */
