 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\CustomDeliveryWindowType|string $Type
...
class CustomDeliveryWindowDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\CustomDeliveryWindowType|string $type
     * @return $this
     */
