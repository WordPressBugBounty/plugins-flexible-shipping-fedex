 ...
 *
 * @property \FedEx\UploadDocumentService\SimpleType\ReturnedShippingDocumentType|string $Type
 * @property Localization[] $Localizations
 * @property \FedEx\UploadDocumentService\SimpleType\ShippingDocumentGroupingType|string $Grouping
 * @property \FedEx\UploadDocumentService\SimpleType\ShippingDocumentDispositionType|string $ShippingDocumentDisposition
...
class ShippingDocument extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ReturnedShippingDocumentType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ShippingDocumentGroupingType|string $grouping
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\ShippingDocumentDispositionType|string $shippingDocumentDisposition
     * @return $this
     */
