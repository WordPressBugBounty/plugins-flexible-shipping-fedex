 ...
 *
 * @property string $Id
 * @property \FedEx\UploadDocumentService\SimpleType\FreightClassType|string $FreightClass
 ...
 * @property \FedEx\UploadDocumentService\SimpleType\PhysicalPackagingType|string $Packaging
 * @property int $Pieces
 * @property string $NmfcCode
 * @property \FedEx\UploadDocumentService\SimpleType\HazardousCommodityOptionType|string $HazardousMaterials
...
class FreightShipmentLineItem extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\FreightClassType|string $freightClass
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\PhysicalPackagingType|string $packaging
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentService\SimpleType\HazardousCommodityOptionType|string $hazardousMaterials
     * @return $this
     */
