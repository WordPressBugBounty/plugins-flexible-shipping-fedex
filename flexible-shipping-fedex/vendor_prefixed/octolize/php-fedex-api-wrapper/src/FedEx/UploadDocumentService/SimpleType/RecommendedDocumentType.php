...
class RecommendedDocumentType extends AbstractSimpleType
{
    ...
    const _USMCA_CERTIFICATION_OF_ORIGIN_ENGLISH = 'USMCA_CERTIFICATION_OF_ORIGIN_ENGLISH';
    const _USMCA_CERTIFICATION_OF_ORIGIN_FRENCH = 'USMCA_CERTIFICATION_OF_ORIGIN_FRENCH';
    const _USMCA_CERTIFICATION_OF_ORIGIN_SPANISH = 'USMCA_CERTIFICATION_OF_ORIGIN_SPANISH';
    const _USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN_ENGLISH = 'USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN_ENGLISH';
    const _USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN_FRENCH = 'USMCA_COMMERCIAL_INVOICE_CERTIFICATION_OF_ORIGIN_FRENCH';
