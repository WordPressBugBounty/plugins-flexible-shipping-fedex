...
class Plugin implements JsonSerializable
{
    ...
    private function prepare_buy_plugin_label(): string
    {
        ...
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'flexible-shipping-fedex') : __('Buy plugin →', 'flexible-shipping-fedex');
    }
}
