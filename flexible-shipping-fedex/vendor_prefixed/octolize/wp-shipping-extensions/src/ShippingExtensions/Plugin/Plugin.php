...
class Plugin implements \JsonSerializable
{
    ...
    {
        return $this->category === \FedExVendor\Octolize\ShippingExtensions\Plugin\PluginFactory::get_categories()[\FedExVendor\Octolize\ShippingExtensions\Plugin\PluginFactory::CATEGORY_BUNDLES] ? \__('Buy bundle →', 'flexible-shipping-fedex') : \__('Buy plugin →', 'flexible-shipping-fedex');
    }
}
