 ...
 */
class HttpServerErrorEventListener extends \FedExVendor\CageA80\FedEx\Listeners\BaseEventListener
{
    /**
     * Handle the event.
     *
     ...
     * @return void
     */
    public function handle(\FedExVendor\CageA80\FedEx\Events\HttpServerError $event)
    {
