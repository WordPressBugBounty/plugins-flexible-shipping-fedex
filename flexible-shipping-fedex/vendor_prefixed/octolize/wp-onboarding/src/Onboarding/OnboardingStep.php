...
class OnboardingStep implements \JsonSerializable
{
     ...
     */
    public function set_id(string $id) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->id = $id;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_step(int $step) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->step = $step;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_logo(bool $logo) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->logo = $logo;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_title(string $title) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->title = $title;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_show(bool $show) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->show = $show;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_image(string $image) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->image = $image;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_heading(string $heading) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_sub_heading(string $sub_heading) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_buttons(array $buttons) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->buttons = $buttons;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_content(array $content) : \FedExVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->content = $content;
        return $this;
    }
    ...
    private function serializeContent() : array
    {
        ...
        foreach ($this->content as $field) {
            ...
            if ($field instanceof \FedExVendor\WPDesk\Forms\Field\CheckboxField) {
