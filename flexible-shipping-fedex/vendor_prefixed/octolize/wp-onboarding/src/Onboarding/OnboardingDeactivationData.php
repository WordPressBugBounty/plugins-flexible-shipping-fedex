 ...
 */
class OnboardingDeactivationData implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(string $plugin_file, \FedExVendor\Octolize\Onboarding\OnboardingOption $onboarding_option)
    {
