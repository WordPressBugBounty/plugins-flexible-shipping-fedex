 ...
 */
class Onboarding implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const VERSION = 2;
     ...
     */
    public function __construct(string $onboarding_id, bool $autostart, \FedExVendor\Octolize\Onboarding\OnboardingShouldShowStrategy $onboarding_should_show_strategy, array $steps, \FedExVendor\Octolize\Onboarding\OnboardingAjax $tracker_ajax, \FedExVendor\Octolize\Onboarding\OnboardingOption $onboarding_option)
    {
    ...
    {
        if ($this->autostart) {
            $this->onboarding_option->update_option(\FedExVendor\Octolize\Onboarding\OnboardingOption::AUTO_SHOW_POPUP, 1);
            $this->onboarding_option->update_option(\FedExVendor\Octolize\Onboarding\OnboardingOption::VIEWS, (int) $this->onboarding_option->get_option_value(\FedExVendor\Octolize\Onboarding\OnboardingOption::VIEWS, 0) + 1);
        }
        $this->onboarding_option->update_option(\FedExVendor\Octolize\Onboarding\OnboardingOption::PAGE, \sanitize_text_field($page));
        $this->onboarding_option->update_option(\FedExVendor\Octolize\Onboarding\OnboardingOption::EVENT_TIME, \time());
        $this->onboarding_option->update_option(\FedExVendor\Octolize\Onboarding\OnboardingOption::EVENT, 'render');
    }
    /**
     * @return bool
     */
