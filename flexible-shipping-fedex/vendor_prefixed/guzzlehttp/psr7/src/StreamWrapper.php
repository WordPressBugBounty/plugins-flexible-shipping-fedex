...
final class StreamWrapper
{
     ...
     */
    public static function getResource(\FedExVendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\FedExVendor\Psr\Http\Message\StreamInterface $stream)
    {
