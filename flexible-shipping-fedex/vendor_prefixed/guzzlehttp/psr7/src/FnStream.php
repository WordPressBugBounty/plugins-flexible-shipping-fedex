...
final class FnStream implements \FedExVendor\Psr\Http\Message\StreamInterface
{
     ...
     * @return FnStream
     */
    public static function decorate(\FedExVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
