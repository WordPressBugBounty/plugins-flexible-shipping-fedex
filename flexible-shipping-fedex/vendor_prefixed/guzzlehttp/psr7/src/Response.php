 ...
 */
class Response implements \FedExVendor\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \FedExVendor\Psr\Http\Message\ResponseInterface
    {
