 ...
 */
final class AppendStream implements \FedExVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\FedExVendor\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \FedExVendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
