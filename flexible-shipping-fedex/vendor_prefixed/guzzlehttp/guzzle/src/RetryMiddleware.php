...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\FedExVendor\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\FedExVendor\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\FedExVendor\Psr\Http\Message\RequestInterface $request, array $options, \FedExVendor\Psr\Http\Message\ResponseInterface $response = null) : \FedExVendor\GuzzleHttp\Promise\PromiseInterface
    {
