...
final class TransferStats
{
     ...
     */
    public function __construct(\FedExVendor\Psr\Http\Message\RequestInterface $request, \FedExVendor\Psr\Http\Message\ResponseInterface $response = null, float $transferTime = null, $handlerErrorData = null, array $handlerStats = [])
    {
     ...
     */
    public function getEffectiveUri() : \FedExVendor\Psr\Http\Message\UriInterface
    {
