...
class CurlHandler
{
    ...
    {
        $this->factory = $options['handle_factory'] ?? new \FedExVendor\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(\FedExVendor\Psr\Http\Message\RequestInterface $request, array $options) : \FedExVendor\GuzzleHttp\Promise\PromiseInterface
    {
        ...
        return \FedExVendor\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
