...
use FedExVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FedExVendor\Monolog\Logger;
use FedExVendor\Monolog\Formatter\FormatterInterface;
use FedExVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FedExVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FedExVendor\Elasticsearch\Client;
use FedExVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FedExVendor\Elastic\Elasticsearch\Client as Client8;
/**
