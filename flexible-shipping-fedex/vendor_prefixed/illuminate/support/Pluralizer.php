...
use FedExVendor\Doctrine\Inflector\Inflector;
use FedExVendor\Doctrine\Inflector\InflectorFactory;
class Pluralizer
{
    /**
    ...
    public static function inflector()
    {
        ...
        if (\is_null($inflector)) {
            $inflector = \FedExVendor\Doctrine\Inflector\InflectorFactory::createForLanguage('english')->build();
        }
        return $inflector;
    }
}
