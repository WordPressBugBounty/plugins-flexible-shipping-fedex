...
use FedExVendor\Carbon\Factory;
...
class DateFactory
{
     ...
     * @var string
     */
    const DEFAULT_CLASS_NAME = \FedExVendor\Illuminate\Support\Carbon::class;
    /**
    ...
    public static function use($handler)
    {
        ...
        } elseif ($handler instanceof \FedExVendor\Carbon\Factory) {
