...
class Arr
{
    ...
    public static function collapse($array)
    {
        ...
        foreach ($array as $values) {
            if ($values instanceof \FedExVendor\Illuminate\Support\Collection) {
                $values = $values->all();
    ...
    {
        if ($array instanceof \FedExVendor\Illuminate\Support\Enumerable) {
    ...
    public static function flatten($array, $depth = \INF)
    {
        $result = [];
        foreach ($array as $item) {
            $item = $item instanceof \FedExVendor\Illuminate\Support\Collection ? $item->all() : $item;
            if (!\is_array($item)) {
                $result[] = $item;
            } else {
    ...
    {
        return \FedExVendor\Illuminate\Support\Collection::make($array)->sortBy($callback)->all();
    }
    /**
