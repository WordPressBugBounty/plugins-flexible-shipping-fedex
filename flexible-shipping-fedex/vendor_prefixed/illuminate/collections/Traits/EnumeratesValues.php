...
use FedExVendor\Illuminate\Support\Enumerable;
use FedExVendor\Illuminate\Support\HigherOrderCollectionProxy;
use FedExVendor\Illuminate\Support\HigherOrderWhenProxy;
...
trait EnumeratesValues
{
    ...
    {
        return $value instanceof \FedExVendor\Illuminate\Support\Enumerable ? new static($value) : new static(\FedExVendor\Illuminate\Support\Arr::wrap($value));
    }
    /**
    ...
    {
        return $value instanceof \FedExVendor\Illuminate\Support\Enumerable ? $value->all() : $value;
    }
    /**
    ...
    {
        (new \FedExVendor\Illuminate\Support\Collection(\func_get_args()))->push($this->all())->each(function ($item) {
            \FedExVendor\Symfony\Component\VarDumper\VarDumper::dump($item);
        });
        return $this;
    }
    /**
    ...
    {
        if (!$callback) {
            return new \FedExVendor\Illuminate\Support\HigherOrderWhenProxy($this, $value);
        }
        if ($value) {
    ...
    {
        return new \FedExVendor\Illuminate\Support\Collection($this->all());
    }
    /**
    ...
    public function toArray()
    {
        return $this->map(function ($value) {
            return $value instanceof \FedExVendor\Illuminate\Contracts\Support\Arrayable ? $value->toArray() : $value;
        })->all();
    }
    /**
    ...
    public function jsonSerialize()
    {
        return \array_map(function ($value) {
            ...
            } elseif ($value instanceof \FedExVendor\Illuminate\Contracts\Support\Jsonable) {
                return \json_decode($value->toJson(), \true);
            } elseif ($value instanceof \FedExVendor\Illuminate\Contracts\Support\Arrayable) {
    ...
    public function __get($key)
    {
        ...
        return new \FedExVendor\Illuminate\Support\HigherOrderCollectionProxy($this, $key);
    }
    /**
    ...
    protected function getArrayableItems($items)
    {
        if (\is_array($items)) {
            return $items;
        } elseif ($items instanceof \FedExVendor\Illuminate\Support\Enumerable) {
            return $items->all();
        } elseif ($items instanceof \FedExVendor\Illuminate\Contracts\Support\Arrayable) {
            return $items->toArray();
        } elseif ($items instanceof \FedExVendor\Illuminate\Contracts\Support\Jsonable) {
