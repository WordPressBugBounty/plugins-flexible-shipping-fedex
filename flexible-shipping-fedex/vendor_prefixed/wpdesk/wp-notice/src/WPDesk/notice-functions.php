...
if (!\function_exists('FedExVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \FedExVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('FedExVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('FedExVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('FedExVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::notice($noticeContent, \FedExVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('FedExVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::notice($noticeContent, \FedExVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('FedExVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::notice($noticeContent, \FedExVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('FedExVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::notice($noticeContent, \FedExVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('FedExVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \FedExVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('FedExVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
