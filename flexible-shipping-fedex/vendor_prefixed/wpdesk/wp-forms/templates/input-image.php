...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-shipping-fedex');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-shipping-fedex');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-shipping-fedex');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-shipping-fedex');
?>"
				},
				library: {
					type: ['image']
