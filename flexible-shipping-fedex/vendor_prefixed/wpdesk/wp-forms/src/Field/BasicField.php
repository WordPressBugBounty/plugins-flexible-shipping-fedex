...
use FedExVendor\WPDesk\Forms\Sanitizer\NoSanitize;
use FedExVendor\WPDesk\Forms\Serializer;
use FedExVendor\WPDesk\Forms\Validator;
use FedExVendor\WPDesk\Forms\Validator\ChainValidator;
use FedExVendor\WPDesk\Forms\Validator\RequiredValidator;
/**
 * Base class for fields. Is responsible for settings all required field values and provides standard implementation for
 * the field interface.
 */
abstract class BasicField implements \FedExVendor\WPDesk\Forms\Field
{
    ...
    public function set_type(string $type) : \FedExVendor\WPDesk\Forms\Field
    {
        $this->meta['type'] = $type;
        return $this;
    }
    ...
    {
        $chain = new \FedExVendor\WPDesk\Forms\Validator\ChainValidator();
        if ($this->is_required()) {
            $chain->attach(new \FedExVendor\WPDesk\Forms\Validator\RequiredValidator());
        }
        return $chain;
    }
    public function get_sanitizer() : \FedExVendor\WPDesk\Forms\Sanitizer
    {
        return new \FedExVendor\WPDesk\Forms\Sanitizer\NoSanitize();
    }
    ...
    public final function set_label(string $value) : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_description(string $value) : \FedExVendor\WPDesk\Forms\Field
    {
        $this->meta['description'] = $value;
        return $this;
    }
    public final function set_description_tip(string $value) : \FedExVendor\WPDesk\Forms\Field
    {
        $this->meta['description_tip'] = $value;
        return $this;
    }
    public final function set_placeholder(string $value) : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_name(string $name) : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_disabled() : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_readonly() : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_required() : \FedExVendor\WPDesk\Forms\Field
    {
        $this->attributes['required'] = 'required';
        return $this;
    }
    public final function add_class(string $class_name) : \FedExVendor\WPDesk\Forms\Field
    {
        $this->attributes['class'][$class_name] = $class_name;
        return $this;
    }
    public final function unset_class(string $class_name) : \FedExVendor\WPDesk\Forms\Field
    {
        unset($this->attributes['class'][$class_name]);
        return $this;
    }
    public final function add_data(string $data_name, string $data_value) : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function unset_data(string $data_name) : \FedExVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_default_value(string $value) : \FedExVendor\WPDesk\Forms\Field
    {
     ...
     */
    public final function set_priority(int $priority) : \FedExVendor\WPDesk\Forms\Field
    {
