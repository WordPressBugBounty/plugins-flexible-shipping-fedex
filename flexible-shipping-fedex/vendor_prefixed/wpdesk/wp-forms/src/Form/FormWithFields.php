...
namespace FedExVendor\WPDesk\Forms\Form;

use FedExVendor\Psr\Container\ContainerInterface;
use FedExVendor\WPDesk\Forms\ContainerForm;
...
class FormWithFields implements \FedExVendor\WPDesk\Forms\Form, \FedExVendor\WPDesk\Forms\ContainerForm, \FedExVendor\WPDesk\Forms\FieldProvider
{
    ...
    /** @return void */
    public function add_field(\FedExVendor\WPDesk\Forms\Field $field)
    {
        $this->fields[] = $field;
    }
    ...
    public function set_data(\FedExVendor\Psr\Container\ContainerInterface $data)
    {
        foreach ($this->fields as $field) {
            ...
            if ($data->has($data_key)) {
                ...
                } catch (\FedExVendor\WPDesk\Persistence\ElementNotExistsException $e) {
    ...
    public function render_fields(\FedExVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
        $content = '';
    ...
    public function render_form(\FedExVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
    ...
    {
        $fields = $this->fields;
        \usort($fields, static function (\FedExVendor\WPDesk\Forms\Field $a, \FedExVendor\WPDesk\Forms\Field $b) {
