...
namespace FedExVendor\WPDesk\Forms\Renderer;

use FedExVendor\WPDesk\Forms\Field;
use FedExVendor\WPDesk\Forms\FieldProvider;
use FedExVendor\WPDesk\Forms\FieldRenderer;
/**
 * Can render form fields as JSON.
 *
 * @package WPDesk\Forms\Renderer
 */
class JsonNormalizedRenderer implements \FedExVendor\WPDesk\Forms\FieldRenderer
{
    /**
     ...
     */
    public function render_fields(\FedExVendor\WPDesk\Forms\FieldProvider $provider, array $fields_data, string $name_prefix = '') : array
    {
        $rendered_fields = [];
