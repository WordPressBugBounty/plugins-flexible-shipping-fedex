...
interface Field
{
    ...
    public function add_data(string $data_name, string $data_value) : \FedExVendor\WPDesk\Forms\Field;
    public function unset_data(string $data_name) : \FedExVendor\WPDesk\Forms\Field;
    /** @return mixed */
