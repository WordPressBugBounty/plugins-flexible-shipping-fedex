 ...
 */
class WooTemplateResolver implements \FedExVendor\WPDesk\View\Resolver\Resolver
{
    /** @var string */
    private $base_path;
    ...
    public function resolve($name, \FedExVendor\WPDesk\View\Renderer\Renderer $renderer = null) : string
    {
        ...
        if ($template === '') {
            throw new \FedExVendor\WPDesk\View\Resolver\Exception\CanNotResolve("Cannot resolve template {$name}");
        }
        return $template;
    }
}
