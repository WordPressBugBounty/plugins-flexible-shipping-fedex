...
class ConnectionChecker
{
     ...
     */
    public function __construct(\FedExVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \FedExVendor\Psr\Log\LoggerInterface $logger, $is_testing, $auth_provider_class = null)
    {
    ...
    {
        if ($this->settings->get_value(\FedExVendor\WPDesk\FedexShippingService\FedexSettingsDefinition::API_TYPE, \FedExVendor\WPDesk\FedexShippingService\FedexSettingsDefinition::API_TYPE_SOAP) === \FedExVendor\WPDesk\FedexShippingService\FedexSettingsDefinition::API_TYPE_SOAP) {
    ...
    {
        $fedex = new \FedExVendor\CageA80\FedEx\FedEx((new \FedExVendor\WPDesk\FedexShippingService\FedexApi\RestApi\RestApiConfig($this->settings, $this->auth_provider_class))->prepare_config());
        ...
        try {
            ...
            throw new \FedExVendor\WPDesk\AbstractShipping\Exception\ApiConnectionCheckerException($e->getMessage());
        }
    }
}
