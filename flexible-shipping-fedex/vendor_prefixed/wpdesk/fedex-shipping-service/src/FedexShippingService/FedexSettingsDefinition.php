...
class FedexSettingsDefinition extends \FedExVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition
{
     ...
     * FedEx services.
     */
    const SERVICES = [\FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_2_DAY_AM => 'FedEx 2Day A.M.', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_2_DAY => 'FedEx 2Day', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_EXPRESS_SAVER => 'FedEx Express Saver', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_GROUND => 'FedEx Ground', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_GROUND_HOME_DELIVERY => 'FedEx Ground Home Delivery', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_SMART_POST => 'FedEx Ground Economy (Formerly known as SmartPost)', self::FEDEX_INTERNATIONAL_CONNECT_PLUS => 'FedEx International Connect Plus', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_INTERNATIONAL_ECONOMY => 'FedEx International Economy', self::INTERNATIONAL_GROUND => 'FedEx International Ground', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_EUROPE_FIRST_INTERNATIONAL_PRIORITY => 'FedEx Europe First International Priority', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FIRST_OVERNIGHT => 'FedEx Overnight', self::FEDEX_PRIORITY => 'FedEx Priority', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_PRIORITY_OVERNIGHT => 'FedEx Priority Overnight', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_STANDARD_OVERNIGHT => 'FedEx Standard Overnight', self::FEDEX_REGIONAL_ECONOMY => 'FedEx Regional Economy', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_INTERNATIONAL_FIRST => 'FedEx International First', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_INTERNATIONAL_PRIORITY => 'FedEx International Priority', self::FEDEX_INTERNATIONAL_PRIORITY => 'FedEx International Priority', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_DISTANCE_DEFERRED => 'FedEx Distance Deferred', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_AFTERNOON => 'FedEx Next Day Afternoon', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_EARLY_MORNING => 'FedEx Next Day Early Morning', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_END_OF_DAY => 'FedEx Next Day End of Day', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_FREIGHT => 'FedEx Next Day Freight', \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_MID_MORNING => 'FedEx Next Day Mid Morning', self::FEDEX_FIRST => 'FedEx First', self::FEDEX_PRIORITY_EXPRESS => 'FedEx Priority Express', self::FEDEX_ECONOMY_SELECT => 'FedEx Economy'];
    const UK_SERVICES = [\FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_DISTANCE_DEFERRED, \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_AFTERNOON, \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_EARLY_MORNING, \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_END_OF_DAY, \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_FREIGHT, \FedExVendor\FedEx\RateService\SimpleType\ServiceType::_FEDEX_NEXT_DAY_MID_MORNING, self::FEDEX_FIRST, self::FEDEX_PRIORITY_EXPRESS, self::FEDEX_PRIORITY, self::FEDEX_ECONOMY_SELECT];
