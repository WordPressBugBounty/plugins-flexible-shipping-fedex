...
namespace FedExVendor\Psr\Log\Test;

use FedExVendor\Psr\Log\LoggerInterface;
use FedExVendor\Psr\Log\LogLevel;
use FedExVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FedExVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FedExVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FedExVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
