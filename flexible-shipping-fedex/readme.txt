...
Yes. Our FedEx WooCommerce plugin requires to have a registered user account in order to connect to the FedEx API.
 You can quickly sign up at [FedEx.com](https://developer.fedex.com/api/en-us/home.html). You may also check our guide [How to create a FedEx account](https://octol.io/fedex-repo-account).
...
= 4.4.4 - 2026-08-19 =
* Updated the FedEx Live Rates PRO link and added a five-star rating link to the Plugins screen
...
= 4.4.0 - 2026-07-13 =
* Added an AI chat assistant to FedEx settings

= 4.3.0 - 2026-06-11 =
* Added information about promotions in the Shipping Extensions tab
...
= 4.2.0 - 2026-02-19 =
* Added notice informing about the planned SOAP API shutdown
* Removed SOAP module requirement from the main plugin file
...
= 4.0.12 - 2025-08-18 =changelog goes here
* Changed CSAT form display logic
...
= 3.0.2 - 2024-06-25 =
* Fixed province codes in FedEx REST API

= 3.0.1 - 2024-06-09 =
* Added support for WooCommerce 9.0

= 3.0.0 - 2024-06-05 =
* Added FedEx REST API support
...
* Added FedEx services: FedEx First, FedEx Priority Express, FedEx Economy

= 2.8.1 - 2024-03-25 =
* Added support for WordPress 6.5

= 2.8.0 - 2024-03-19 =
* Logs moved to WooCommerce
